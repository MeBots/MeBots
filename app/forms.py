...
class BotForm(FlaskForm):
    ...
    prefix_filter = BooleanField('Ignore messages without prefix', validators=[Length(max=20)], description='Prevent receipt of messages that don\'t query your bot. May help save on hosting costs.')
    test_group = StringField('Link to join testing/informational group', validators=[Length(max=60)], render_kw={'placeholder': 'groupme.com/join_group/abcdefgh/12345678'})
